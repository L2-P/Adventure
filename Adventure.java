   ...
   while (play.equals("yes") || play.equals("Yes"))
   {
    ...
    else if (hi == 5)
    {
       ...
       if (AST == 3)
       {
        ...
        System.out.println("You traverse through the thick brush for hours and hear the sounds of vehicles. If you hear more than five of these sounds, you can be sure it is not a helusination, but if you hear too many,it could be a helusination.");
